import { a as createLucideIcon, j as jsxRuntimeExports, f as useCart, q as useCartTotals, u as useNavigate, r as reactExports, S as ShoppingBag, B as Button, L as Link, m as motion, A as AnimatePresence, F as FREE_DELIVERY_THRESHOLD, D as DELIVERY_CHARGE } from "./index-6i6bSDXp.js";
import { L as Label, I as Input, T as Textarea } from "./textarea-BWx3wxw9.js";
import { S as Separator } from "./separator-DbZEa9s1.js";
import { u as useLoyaltyPointsStore, L as LOYALTY_REDEEM_POINTS, a as LOYALTY_REDEEM_VALUE, d as discountForPoints, p as pointsForOrder } from "./useLoyaltyPoints-BSDGr_l4.js";
...
function buildFullWhatsAppMessage(items, subtotal, delivery, total, form, giftWrapping, loyaltyDiscount) {
  ...
  const lines = [
    ...
    ...loyaltyDiscount > 0 ? [`loyalty discount: -₹${loyaltyDiscount} ✨`] : [],
    `*total: ₹${total}*`,
    "",
...
function CartPage() {
  ...
  const [redeemLoyaltyOn, setRedeemLoyaltyOn] = reactExports.useState(false);
  const giftWrapCharge = giftWrapping ? GIFT_WRAP_CHARGE : 0;
  const preDiscountTotal = subtotal + delivery + giftWrapCharge;
  const loyaltyDiscount = redeemLoyaltyOn ? Math.min(discountForPoints(loyaltyPoints), preDiscountTotal) : 0;
                    ...
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 font-body text-xs text-foreground/80", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "loyalty-chip", children: [
                              "✨ ",
                              loyaltyPoints,
                              " pts"
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "loyalty points" })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "label",
                            {
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "span",
                                  {
                                    ...
                                    style: {
                                      width: 18,
                                      height: 18,
                                      borderColor: redeemLoyaltyOn && loyaltyPoints >= LOYALTY_REDEEM_POINTS ? "#A8B5A2" : "#D1C4BC",
                                      background: redeemLoyaltyOn && loyaltyPoints >= LOYALTY_REDEEM_POINTS ? "#A8B5A2" : "transparent"
                                    },
                                    children: redeemLoyaltyOn && loyaltyPoints >= LOYALTY_REDEEM_POINTS && /* @__PURE__ */ jsxRuntimeExports.jsx(
                                      "svg",
                                      {
                                        viewBox: "0 0 12 12",
                                        fill: "none",
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-foreground/80", children: "redeem" })
                              ]
                            }
                          )
                        ] }),
                        loyaltyPoints >= LOYALTY_REDEEM_POINTS ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body text-muted-foreground mt-2 leading-relaxed", children: Math.floor(loyaltyPoints / LOYALTY_REDEEM_POINTS) * LOYALTY_REDEEM_VALUE > 0 ? `redeem ${Math.floor(loyaltyPoints / LOYALTY_REDEEM_POINTS) * LOYALTY_REDEEM_POINTS} pts for ₹${Math.floor(loyaltyPoints / LOYALTY_REDEEM_POINTS) * LOYALTY_REDEEM_VALUE} off` : `redeem ${LOYALTY_REDEEM_POINTS} pts for ₹${LOYALTY_REDEEM_VALUE} off` }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-body text-muted-foreground mt-2 leading-relaxed", children: [
                          "earn ",
                          ...
                          " discount — you're",
                          " ",
                          LOYALTY_REDEEM_POINTS - loyaltyPoints,
                          " pts away"
                        ] }),
                        redeemLoyaltyOn && loyaltyDiscount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "div",
                          {
                            className: "flex justify-between text-xs font-body font-semibold mt-2",
                            style: { color: "#5E7A5A" },
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "loyalty discount" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                                "-₹",
                                loyaltyDiscount
                              ] })

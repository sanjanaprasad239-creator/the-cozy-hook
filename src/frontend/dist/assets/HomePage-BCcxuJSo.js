import { c as create, p as persist, r as reactExports, j as jsxRuntimeExports, A as AnimatePresence, m as motion, X, u as useNavigate, L as Link, B as Button, C as CustomOrderModal } from "./index-C1CLqs17.js";
import { P as ProductCard } from "./ProductCard-SqralDhs.js";
import { u as useAdmin, g as getFeaturedProducts, F as FEATURED_PRODUCT_IDS, A as ALL_PRODUCTS, a as getProductById } from "./useAdmin-C9VCVdVv.js";
import { l as loadAllReviews } from "./useQueries-BDkGUG-2.js";
import "./plus-DzGOMaIk.js";
...
function SpinWheelModal() {
  const { shouldShowPopup, hasSpun, markSpun, getDiscountCode } = useSpinWheel();
  const [open, setOpen] = reactExports.useState(false);
  const [spinning, setSpinning] = reactExports.useState(false);
  const [rotation, setRotation] = reactExports.useState(0);
  const [wonDiscount, setWonDiscount] = reactExports.useState(null);
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 pt-8 pb-6 flex flex-col items-center gap-5 text-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-primary tracking-[0.18em] uppercase mb-1", children: "exclusive offer" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-semibold text-foreground", children: "🎡 spin & save!" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 font-body text-sm text-muted-foreground", children: "spin the wheel to unlock a special discount just for you 🌸" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-48 h-48 flex-shrink-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      "aria-hidden": "true",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    motion.div,
                    {
                      ...
                      ${SEGMENTS[3].color} 270deg 360deg
                        ...
                        rotate: rotation,
                        transition: spinning ? `rotate ${SPIN_DURATION_MS}ms cubic-bezier(0.25, 0.46, 0.45, 0.94)` : "none"
                      },
                      "aria-hidden": "true",
                      children: [
                        SEGMENTS.map((seg, i) => {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-5 h-5 rounded-full bg-card border-2 border-border/40 z-10" })
                      ]
                    }
                  )
                ] }),
                wonDiscount === null && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    onClick: spinWheel,
                    ...
                    style: {
                      background: spinning ? "oklch(0.88 0.04 75 / 0.5)" : "oklch(0.72 0.09 5)",
                      color: spinning ? "oklch(0.40 0.04 5)" : "#fff"
                    },
                    children: spinning ? "spinning..." : "spin the wheel! 🎡"
                  }
                ),
                wonDiscount !== null && !claimed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full flex flex-col gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground", children: "you won!" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display text-2xl font-semibold text-foreground", children: [
                          wonDiscount,
                          "% off 🎉"
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground mt-1", children: "enter your email to claim your code" })
                      ]
                    }
                  ),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      children: "claim my discount!"
                    }
                  )
                ] }),
                claimed && wonDiscount !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground", children: "your discount code:" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          className: "font-display text-2xl font-bold tracking-widest",
                          style: { color: "oklch(0.45 0.09 145)" },
                          children: getDiscountCode(wonDiscount)
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground text-center", children: "mention this code when placing your order via WhatsApp 🌸" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
...
function HomePage() {
  ...
  const activeBundles = ((settings == null ? void 0 : settings.bundles) ?? []).filter((b) => b.isActive).slice(0, 3);
  const pressEntries = (settings == null ? void 0 : settings.pressEntries) ?? [];
  const currentlyCrafting = (settings == null ? void 0 : settings.currentlyCrafting) ?? "";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    currentlyCrafting && /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-6 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto bg-[#F7F3EE] border border-[#A8B5A2]/30 rounded-xl p-6 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl mb-2", children: "🧶" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg text-[#3A3A3A] mb-1", children: "currently crafting ✨" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[#3A3A3A]/70", children: currentlyCrafting })
    ] }) }),
    ...
    activeBundles.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 px-4 bg-[#F7F3EE]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl text-[#3A3A3A] text-center mb-2", children: "bundle & save" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-[#3A3A3A]/60 mb-8", children: "better together, better value" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: activeBundles.map(
        (bundle) => {
          var _a;
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg text-[#3A3A3A]", children: bundle.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "bg-[#D8A7B1] text-white text-xs px-2 py-1 rounded-full ml-2 whitespace-nowrap", children: [
                    "save ₹",
                    bundle.savings
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-[#3A3A3A]/60 mb-3", children: bundle.description }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4", children: (_a = bundle.productIds) == null ? void 0 : _a.map((pid) => {
                  const p = getProductById(pid);
                  return p ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-[#3A3A3A]/70", children: [
                    "• ",
                    p.name
                  ] }, pid) : null;
                }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-lg font-semibold text-[#D8A7B1]", children: [
                  "₹",
                  bundle.price
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-8 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs uppercase tracking-widest text-[#3A3A3A]/40 mb-4", children: "as seen in" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-3", children: (pressEntries.length > 0 ? pressEntries : [
        {
          id: "1",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SpinWheelModal, {})
  ] });
}
export {
  HomePage

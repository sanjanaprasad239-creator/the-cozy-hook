import { a as createLucideIcon, j as jsxRuntimeExports, d as cn, r as reactExports, B as Button, e as useParams, u as useNavigate, f as useCart, g as useWishlist, L as Link, m as motion, E as ExternalLink, S as ShoppingBag, H as Heart, h as useWhatsAppOptIn } from "./index-6i6bSDXp.js";
import { L as Label, I as Input, T as Textarea } from "./textarea-BWx3wxw9.js";
import { u as useProductImages, P as ProductCard } from "./ProductCard-BRzEJ4rf.js";
import { u as ue } from "./index-Dm-JFUdO.js";
import { b as useCreateReview, u as useAdmin, a as getProductById, c as useProductReviews, d as getProductsByCategory, A as ALL_PRODUCTS, e as useSubscribeBackInStock } from "./useAdmin-DBC0Pr5K.js";
import { M as Minus } from "./minus-BHMwd35F.js";
...
function ViewerCount() {
  const count = reactExports.useRef(Math.floor(Math.random() * 7) + 2);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "live-viewing", "data-ocid": "product.viewer_count", children: [
...
function CountdownBadge({
  ...
  const timeText = diffDays >= 1 ? `${diffDays} day${diffDays > 1 ? "s" : ""}` : `${diffHours} hour${diffHours !== 1 ? "s" : ""}`;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-xl text-xs font-body",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-semibold text-foreground", children: "stay updated 🌸" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground mt-1", children: "get notified on whatsapp when we add new products or run special offers" })
          ] }),
          submitted ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "you're in! we'll send you the good stuff on whatsapp 🌿"
            }
          ) : alreadySubscribed ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: "font-body text-sm",
              style: { color: "#D8A7B1" },
              "data-ocid": "product.optin_already_subscribed",
              children: "you're already subscribed! 💕"
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "form",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-start gap-2.5 cursor-pointer", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      type: "checkbox",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs", style: { color: "#8A7A74" }, children: "yes, i want to receive offers and updates on whatsapp" })
                ] }),
...
function BackInStockNotify({ productId }) {
  ...
  if (submitted) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4 shrink-0", "aria-hidden": "true" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "you're on the list! we'll email you the moment it's back 🌸" })
        ]
      }
    );
  }
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            children: subscribe.isPending ? "saving…" : "notify me"
          }
        ) })
      ]
    }
...
function ProductPage() {
  ...
  const productTimer = (_a = settings.productTimers) == null ? void 0 : _a[p.id];
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              productImages.has(p.id) ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full aspect-square rounded-3xl overflow-hidden shadow-boutique-lg border border-border/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "img",
                      {
                    ...
                    p.pictureUrl && p.pictureUrl !== "#" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "a",
                      {
                        href: p.pictureUrl,
                        target: "_blank",
              ...
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ViewerCount, {}) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "p",
                      {
                    ...
                    productTimer && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      CountdownBadge,
                      {
                  ...
                  isSoldOut && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "p",
                          {
                            ...
                            children: "back in stock soon! 🌸 leave your email and we'll let you know the moment it's available again."
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(BackInStockNotify, { productId: p.id })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Button,
                      {
                        ...
                        children: isSoldOut ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: "sold out" }) : added ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                        ...
                        "button",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "img",
                              {
                                src: productImages.get(item.id) ?? "/assets/generated/hero-crochet.dim_1600x900.jpg",
                                alt: item.name,
                                className: "w-full h-full object-cover"
                              }
                            ) }),
...
Total: ₹${bundleTotal} 🌸`)}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mt-16", "data-ocid": "product.optin_section", children: /* @__PURE__ */ jsxRuntimeExports.jsx(WhatsAppOptInSection, {}) }),

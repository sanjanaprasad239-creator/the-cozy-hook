import { r as reactExports, j as jsxRuntimeExports, m as motion, A as AnimatePresence } from "./index-6i6bSDXp.js";
...
function CareGuidePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden print:block", "data-ocid": "care_guide.print_sheet", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PrintableSheet, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "print:hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end mb-6 print:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-8", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-semibold text-foreground", children: "size & fit" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground mt-0.5", children: "wearables sizing guide" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-5", children: SIZE_GUIDE.map((item, si) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    motion.div,
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-muted-foreground italic leading-relaxed", children: [
                          "💡 ",
                          item.tip
                        ] })
                      ]
...
function PrintableSheet() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "printable-sheet", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "printable-sheet-head", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "printable-eyebrow", children: "cozy hook" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "printable-title", children: "care guide & product card" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "printable-tagline", children: "handmade with love — a little care keeps every piece beautiful for years." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "printable-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "printable-section-title", children: "care & handling" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "printable-grid", children: CARE_GUIDE.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "printable-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { children: [
          cat.emoji,
          " ",
          cat.label
        ] }),
        cat.care.map((section) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "printable-block", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "printable-block-title", children: section.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: section.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: item }, item)) })
        ] }, section.title))
      ] }, cat.key)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "printable-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "printable-section-title", children: "size & fit" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "printable-grid", children: SIZE_GUIDE.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "printable-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { children: [
          item.emoji,
          " ",
          item.name
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: item.rows.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: row.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: row.detail })
          ] }, row.label)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "printable-tip", children: [
          "💡 ",
          item.tip
        ] })
      ] }, item.name)) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "printable-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "printable-section-title", children: "product card" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "printable-card printable-product-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "printable-product-head", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "cozy hook" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "printable-product-sub", children: "handmade crochet pieces" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "printable-product-note", children: "keep this card with your purchase for easy reference." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("table", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: "material" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: "soft cotton & wool blend yarns" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: "care" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: "hand wash cold, air dry flat, no tumble dry" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: "made by" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: "handmade with love, small-batch" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: "custom sizes" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: "available on request via whatsapp" })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "printable-product-foot", children: "questions? message us on whatsapp — we're happy to help." })
      ] })
    ] })
  ] });
}

...
const BackInStockSubscription = Record({
  "subscribedAt": Int,
  "email": Text
});
...
Service({
  ...
  "getBackInStockSubscribers": Func(
    [Text],
    [Vec(BackInStockSubscription)],
    ["query"]
  ),
  ...
  "notifyBackInStock": Func([Text, Text], [], []),
  ...
  "subscribeBackInStock": Func([Text, Text], [], []),
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const BackInStockSubscription2 = IDL2.Record({
    "subscribedAt": IDL2.Int,
    "email": IDL2.Text
  });
  ...
  return IDL2.Service({
    ...
    "getBackInStockSubscribers": IDL2.Func(
      [IDL2.Text],
      [IDL2.Vec(BackInStockSubscription2)],
      ["query"]
    ),
    ...
    "notifyBackInStock": IDL2.Func([IDL2.Text, IDL2.Text], [], []),
    ...
    "subscribeBackInStock": IDL2.Func([IDL2.Text, IDL2.Text], [], []),
...
class Backend {
  ...
  async getBackInStockSubscribers(arg0) {
    if (this.processError) {
      try {
  ...
  async notifyBackInStock(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async subscribeBackInStock(arg0, arg1) {
    if (this.processError) {
      try {
...
function loadLocalProductImages() {
  try {
...
function saveLocalProductImages(map) {
  try {
...
function useSubscribeBackInStock() {
  const { actor } = useActor(createActor);
  return useMutation({
...
export {
  ...
  useSubscribeBackInStock as e,
  useActor as f,
  getFeaturedProducts as g,
  useAdminSettings as h,
  useProductImages as i,
  useSetProductImage as j,
  createActor as k,
  loadAllReviews as l,
  useAdmin as u
};

      ...
      >
        ...
        <div>
          ...
          <p className="text-muted-foreground font-body max-w-sm">
            Your order details have been sent to WhatsApp. We'll confirm your
            order shortly. Redirecting you home…
          </p>
        </div>
      </div>
    );
    ...
    >
      ...
      >
        ...
        <p className="text-muted-foreground font-body mt-1">
          {itemCount} {itemCount === 1 ? "item" : "items"} ready for order
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          >
            ...
            <div className="space-y-1">
              <Label htmlFor="cart-name" className="font-body text-sm">
            ...
            <div className="space-y-1">
              <Label htmlFor="cart-address" className="font-body text-sm">
            ...
            <div className="space-y-1">
              <Label htmlFor="cart-phone" className="font-body text-sm">
            ...
            <div className="space-y-1">
              <Label htmlFor="cart-notes" className="font-body text-sm">
        ...
        >
          ...
          <div className="space-y-2">
            ...
            {delivery > 0 && (
              <p className="text-xs text-muted-foreground font-body bg-muted/60 rounded-xl px-3 py-2">
